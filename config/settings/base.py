...
HEADLESS_ADAPTER = "users.adapters.HeadlessAdapter"
...
if ALLOW_S3:
    ...
    # https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html#settings
    AWS_STORAGE_REGION_NAME = env("AWS_STORAGE_REGION_NAME", default=None)

    # https://django-storages.readthedocs.io/en/latest/backends/amazon-S3.html#settings
    AWS_S3_CUSTOM_DOMAIN = f"{AWS_STORAGE_BUCKET_NAME}.s3.{AWS_STORAGE_REGION_NAME}.amazonaws.com"
